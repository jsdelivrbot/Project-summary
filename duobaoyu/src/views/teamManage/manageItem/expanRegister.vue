                    ...
                    <div class="form_group2 userInfo_item userInfo_item2">
                     ...
                     <div class="form_group2 userInfo_item userInfo_item2">
                        <div class="input_group input_group_inline">
                            ...
                            <input type="text" v-verify="formData.RealName" v-model="formData.RealName" class="input_common">
                             <span class="formValidateText" v-remind="formData.RealName"></span>
                        </div>
                    </div>
                    <div class="form_group2 userInfo_item userInfo_item2">
                        <div class="input_group input_group_inline">
                     ...
                     <div class="form_group2 userInfo_item userInfo_item2 special_form_group">
                        <div class="input_group input_group_inline">
                            <label class="label"></label>
                            <input type="password" v-if="false" disabled v-verify="formData.L2Pwd" v-model="formData.L2Pwd" class="input_common">
