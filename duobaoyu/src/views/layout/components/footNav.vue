<template>
  <div class="footNav">
      ...
      <!-- 团队管理 -->
       ...
       <!-- 团队管理 -->
      <!-- 交易大厅 -->
       <router-link tag="div" to="/TradingHall/tradeMarket" class="foot_Nav_item_3 foot_Nav_item">
      ...
      <!-- 交易大厅 -->
       <router-link tag="div" to="/wallet/index" class="foot_Nav_item_4 foot_Nav_item" >
          <img class="item_img4" src="static/imgs/footImg_05.png">
          <div class="footNav_text">
              <img src="static/imgs/footText5.png">
          </div>
       </router-link>
       <div class="foot_Nav_item_5 foot_Nav_item" @click="btnAllShouQu">
  ...
  methods: {
    btnAllShouQu() {
      ajax.post("/api/pond/AllShouQu", {}).then(response => {
        ...
        this.$store.dispatch('CloseBubble');
