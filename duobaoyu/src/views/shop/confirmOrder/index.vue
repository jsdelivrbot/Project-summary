<template>
  <div class="model_Box_wrapper Pay_Model" v-if="tableData">
    <div class="model_Box">
      <div class="Title">
  ...
  export default {
    ...
    created() {
     ...
     var queryData=this.$route.query;
      if(this.$route.params.id==='cart'){
      this.tableData = queryData;
      console.log('tableData', queryData);
      this.bindAddress()
      }else{
        this.buyData[0].Product=queryData;
        this.tableData=this.buyData;
        this.$set(this.tableData[0],'Count',queryData.Count)
