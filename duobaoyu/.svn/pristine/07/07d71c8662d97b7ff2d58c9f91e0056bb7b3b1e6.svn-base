                    ...
                    <div class="trade_form">
                        ...
                        <div class="clear_box">
                            ...
                            <div class="trade_form_item trade_form_item_4 input_group input_group_inline">
                                ...
                                <span>{{configData.SellTax*formData.Total/100}}</span>
                            ...
                            <div class="list_items ">
                                <div class="list_item input_group">
                                    ...
                                    <div class="input_group list_group_item">
                                        ...
                                        <span class="">{{configData.SellToChaiFen*formData.Total/100}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="list_items ">
                                <div class="list_item input_group">
                                    ...
                                    <div class="input_group list_group_item">
                                        ...
                                        <span class="">{{configData.SellToGouWu*formData.Total/100}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
