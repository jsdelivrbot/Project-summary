      ...
      $ocLazyLoadProvider.config({
          ...
          modules: [
              ...
              },
              {
                  name: 'ngDialog',
                  files: [
                      'vendor/modules/angular-dialog/ngDialog.js',
                      'vendor/modules/angular-dialog/ngDialog.css',
                      'vendor/modules/angular-dialog/ngDialog-theme-default.css',
                      'vendor/modules/angular-dialog/ngDialog-theme-plain.min.css',
                  ]
              },
             
              {
                  name: 'dialogs.default-translations',
                  files: [
                      'vendor/modules/angular-dialog/dialogs-default-translations.js',
                  ]
              },
              {
                  name: 'textAngular',
